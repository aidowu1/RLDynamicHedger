...
from src.main.utility.enum_types import PlotType, AggregationType
from src.main.utility.utils import Helpers
...
class RLAlgorithmTestCycle:
    ...
    def __init__(
        ...
        self._env = env
        self._agent = agent
        if n_simulation_paths:
            self._n_paths = int(n_simulation_paths)
        else:
            self._n_paths = self._parameters.n_paths
        self._seed = seed
        ...
        self._hedging_type = self._agent.hedging_type
